...
public  class ExampleMenuBar extends MenuBar {
...
//                new SeparatorMenuItem(),
                createItem(
                    "打开文件", Feather.FILE, new KeyCodeCombination(KeyCode.O, CONTROL_DOWN)
                ), createItem(
                            "打开目录", Feather.FOLDER, new KeyCodeCombination(KeyCode.O, CONTROL_DOWN)
                    ),
                openRecentMenu//,
//                new SeparatorMenuItem(),
//                createItem(
