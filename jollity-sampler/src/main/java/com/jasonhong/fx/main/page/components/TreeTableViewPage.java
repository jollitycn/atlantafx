...
import com.jasonhong.fx.main.page.ExampleBox;
...
public final class TreeTableViewPage extends OutlinePage {
    ...
    private com.jasonhong.fx.main.page.ExampleBox usageExample() {
        //snippet_1:start
        ...
        return new ExampleBox(box, new com.jasonhong.fx.main.page.Snippet(getClass(), 1), description);
    }
