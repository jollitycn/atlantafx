...
package com.jasonhong.fx.main.page.components.tablView;
...
public class ProgressBarTableCell<S> extends TableCell<S, Double> {
    ...
    public static <S> Callback<TableColumn<S, Double>, TableCell<S, Double>> forTableColumn() {
        return param -> new ProgressBarTableCell<>();
    }
    ...
    public void updateItem(Double item, boolean empty) {
        ...
        if (empty) {
            ...
            if (observable != null) {
                if (observable.getValue() < 0) {
                    progressBar.getStyleClass().add(Styles.DANGER);
                } else if (observable.getValue()>0.8) {
