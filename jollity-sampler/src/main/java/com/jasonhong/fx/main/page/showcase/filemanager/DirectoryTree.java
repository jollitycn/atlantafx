...
import static com.jasonhong.fx.main.page.showcase.filemanager.Utils.isFileHidden;

final class DirectoryTree extends TreeView<File> {

    @SuppressWarnings({"unchecked", "rawtypes"})
    public DirectoryTree(com.jasonhong.fx.main.page.showcase.filemanager.Model model, File rootPath) {
        super();
        ...
        setCellFactory(c -> new TreeCell<>() {
            ...
            protected void updateItem(File item, boolean empty) {
                ...
                if (empty || item == null) {
                    ...
                    pseudoClassStateChanged(com.jasonhong.fx.main.page.showcase.filemanager.Model.HIDDEN, isFileHidden(item.toPath()));
                }
            }
        });
